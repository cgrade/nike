...
export const Hero = () => {
  return (
    ...
    min-h-screen gap-10 max-container">
      <div className="relate4ive xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px]
          ...
          <br />
          <span
          className="text-coral-red inline-block mt-3">Nike</span>
          Shoes
        </h1>
        <p 
          className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 gap-16"
        >Discover Stylish Nike arrivasl, quality comfort and innovation for you acitve life</p>
        <Button label="Shop n ow" iconURL={arrowRight}/>
